...
public class Tra {
	public static int countLongPositiveNumbers(int[] numbers) {
		int count = 0;
	...
	public static int findLastNegative(int[] numbers) {
		int num = 0;
	...
	public static int multiplyUntil(int start, int target) {
		int result = start;
		while (result < target) {
			result *= 2;
		}
	...
	public static boolean startsAndEndsSame(String word) {
		return word.charAt(0) == word.charAt(word.length() - 1);
	}

	public static int countShortPendingTasks(ArrayList<Task> tasks) {
		int count = 0;
		for (Task task : tasks) {
			if (task.getName().length() < 5 && !task.isDone()) {
				count++;
			}
		}
		return count;
	...
	public static int findFirstEvenOverTen(int[] numbers) {
		for (int number : numbers) {
			if (number % 2 == 0) {
				if (number > 10) {
					return number;
	...
	public static int sumUntilZero(ArrayList<Integer> numbers) {
		int result = 0;
		for (int i = 0; i < numbers.size(); i++) {
			if (numbers.get(i) == 0) {
				break;
	...
	public static int addUntil(int start, int target) {
		int result = start;
		while (result < target) {
			result += 4;
		}
	...
	public static int findFirstEvenIndex(int[] numbers) {
		int ip = -1;
		for (int i = 0; i < numbers.length; i++) {
			if (numbers[i] % 2 == 0) {
				return i;
	...
	public static int countNegatives(ArrayList<Integer> numbers) {
		int count = 0;
		for (int number : numbers) {
			if (number < 0) {
				count++;
	...
	public static int convertAndMultiply(String first, String second) {
		try {
	...
	public static int countAfterLastZero(int[] numbers) {
		int count = 0;
		int lz = -1;
		for (int i = 0; i < numbers.length; i++) {
			if (numbers[i] == 0) {
			...
			if (lz < numbers.length && lz >= 0) {
				count = numbers.length - (lz + 1);
			}
		}
		return count;
	}

	public static int findLastPositiveIndex(ArrayList<Integer> numbers) {
		int ilp = -1;
		for (int i = 0; i < numbers.size(); i++) {
			if (numbers.get(i) >= 0) {
				ilp = i;
	...
	public static int doubleUntil100(int number) {
		int result = number;
		while (result < 100) {
			result *= 2;
		}
	...
	public static int addTenUntilPositive(int number) {
		int result = number;
		do {
			result += 10;
		} while (result <= 0);
	...
	public static int countLetterA1(String text) {
		int count = 0;
	...
	public static int countGoodMovies(ArrayList<Movie> movies) {
		int count = 0;
	...
	public static int findFirstSpace(String text) {
		int result = -1;
	...
	public static int sumUntilNegative(ArrayList<Integer> numbers) {
		int result = 0;
	...
	public static String normalizeScores(ArrayList<Integer> scores) {
		int total = 0;
	...
	public static double normalizeMovieRatings(ArrayList<Movie> movies) {
		double totalRate = 0;
		for (int i = movies.size() - 1; i >= 0; i--) {
			...
			totalRate += movie.getRating();
		}
		return totalRate;
	}

	public static int findFirstValidScore(String[] inputs) {
		int i = 0;
	...
	public static int sumValidDurations(String[] inputs) {
		int i = 0;
		int total = 0;
		while (i < inputs.length) {
			String input = inputs[i];
	...
	public static String findFirstLongMovie(ArrayList<Movie> movies, int limit) {
		int i = 0;
		while (i < movies.size()) {
			Movie m = movies.get(i);
			if (m.getDuration() > limit) {
				return m.getTitle();
			}
			i++;
		}
	...
	public static int findFirstPositiveNumber(String[] inputs) {
		int i = 0;
		while (i < inputs.length) {
			String input = inputs[i];
			try {
	...
	public static int countEvenNumbers(int[][] grid) {
		int count = 0;
		for (int i = 0; i < grid.length; i++) {
			for (int j = 0; j < grid[i].length; j++) {
				if (grid[i][j] % 2 == 0) {
	...
	public static int countValidScores(String[] inputs) {
		int i = 0;
		int count = 0;
		while (i < inputs.length) {
			String input = inputs[i];
	...
	public static int sumPositiveEvenNumbers(int[] numbers) {
		int total = 0;
		int i = 0;
		while (i < numbers.length) {
			int num = numbers[i];
	...
	public static String interpretCommand(String command) {
	...
	public static int sumPositiveMultiplesOfFive(int[] numbers) {
		int i = 0;
		int total = 0;
		while (i < numbers.length) {
			int num = numbers[i];
	...
	public static int removeCompletedTasks(ArrayList<Task> tasks) {
		int count = 0;
	...
	public static String repeatUntilLength(String text, int minimumLength) {
		String result = "";
		do {
			result += text;
	...
	public static int doubleUntilLimit(int number, int limit) {
		do {
			number *= 2;
		} while (number < limit);
		return number;
	...
	public static int findHighestValue(int[][] grid) {
		int num = grid[0][0];
		for (int i = 0; i < grid.length; i++) {
			for (int j = 0; j < grid[i].length; j++) {
				if (num < grid[i][j]) {
	...
	public static int sumValuesAt(String[] inputs, int firstIndex, int secondIndex) {
		try {
			int inp = Integer.parseInt(inputs[firstIndex]);
			int inp2 = Integer.parseInt(inputs[secondIndex]);
			return inp + inp2;
	...
	public static int calculateDeliveryCost(double orderTotal, boolean premium) {
		if (orderTotal < 0) {
			return -1;
		}
		if (premium || orderTotal >= 50) {
			return 0;
	...
	public static int countMatches(String[] words, String targetWord, char targetLetter) {
		int countO = 0;
		for (String word : words) {
			if (word.equals(targetWord) || word.charAt(0) == targetLetter) {
				countO++;
			}
		}
		return countO;
	...
	public static int countBeforeZero(int[] numbers) {
		int count = 0;
		int i = 0;
		do {
			int num = numbers[i];
	...
	public static String findLongestWordAt(String[] words, int firstIndex, int secondIndex) {
		try {
			String w = words[firstIndex];
			String w1 = words[secondIndex];
	...
	public static int countMoviesStartingWith(ArrayList<Movie> movies, char targetLetter) {
		int count = 0;
		for (Movie movie : movies) {
			if (movie.getTitle().charAt(0) == targetLetter) {
				count++;
			}
		}
		return count;
	...
	public static String findLongestMovieTitle(ArrayList<Movie> movies) {
		String movieL = movies.get(0).getTitle();
		for (Movie movie : movies) {
			String title = movie.getTitle();
			if (movieL.length() < title.length()) {
				movieL = title;
			}
		}
		return movieL;
	...
	public static int sumBeforeNegative(int[] numbers) {
		int i = 0;
		int total = 0;
		do {
			int num = numbers[i];
	...
	public static int transformNumber(int number, char command) {
		switch (command) {
		case 'd':
			return number * 2;
		case 'h':
	...
	public static String removeCharacter(String text, char excluded) {
		String result = "";
		for (int i = 0; i < text.length(); i++) {
			if (text.charAt(i) == excluded) {
				continue;
			}
			result += text.charAt(i);
		}
	...
	public static int sumPositiveEvenInputs(String[] inputs) {
		int total = 0;
	...
	public static int countBeforeWord(String[] words, String stopWord) {
		int count = 0;
		int i = 0;
		do {
			String word = words[i];
	...
	public static int transformInput(String input, char command) {
		try {
			int num = Integer.parseInt(input);
			switch (command) {
			case 'd':
	...
	public static int countValuesInRange(int[][] grid, int minimum, int maximum) {
		int count = 0;
		for (int i = 0; i < grid.length; i++) {
			for (int j = 0; j < grid[i].length; j++) {
				int num = grid[i][j];
	...
	public static int removeShortMovieTitles(ArrayList<Movie> movies, int minimumLength) {
		int count = 0;
		for (int i = movies.size() - 1; i >= 0; i--) {
			Movie m = movies.get(i);
			if (m.getTitle().length() < minimumLength) {
				movies.remove(i);
				count++;
			}
		}
	...
	public static int countPositiveEvenBeforeStop(String[] inputs) {
		int i = 0;
		int count = 0;
		while (i < inputs.length) {
	...
	public static String classifyMovie(Movie movie) {
		double mR = movie.getRating();
		int mD = movie.getDuration();
		if (mR < 0 || mR > 10) {
			return "Note invalide";
		} else if (mR >= 0 && mD >= 150) {
			return "Excellent mais long";
		} else if (mR >= 8) {
			return "Excellent";
		} else if (mD >= 150) {
			return "Long";
	...
	public static int countWordsWithMatchingEnds(String[] words) {
		int count = 0;
		for (String word : words) {
	...
	public static int sumPositiveOddBeforeStop(int[] numbers, int stopValue) {
		int total = 0;
		int i = 0;
		while (i < numbers.length) {
	...
	public static int sumLongWordLengths(String[] words, int minimumLength) {
		int i = 0;
		int total = 0;
		while (i < words.length) {
			String word = words[i];
	...
	public static int countRecommendedMovies(ArrayList<Movie> movies, int maximumDuration) {
		int count = 0;
		for (Movie movie : movies) {
			if (movie.getRating() >= 8 && movie.getDuration() <= maximumDuration) {
				count++;
			}
		}
		return count;
	...
	public static int multiplyInputsAt(String[] inputs, int firstIndex, int secondIndex) {
		int total = 0;
		try {
			String input1 = inputs[firstIndex];
			String input2 = inputs[secondIndex];
	...
	public static int applyLevelBonus(int score, String level) {
		switch (level) {
		case "gold":
			return score * 2;
		case "silver":
	...
	public static int calculateValidTotal(String[] inputs, String stopWord) {
		int total = 0;
		int i = 0;
		while (i < inputs.length) {
			String input = inputs[i];
